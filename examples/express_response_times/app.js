...
var app = express();
var serverInflux = influx(['127.0.0.1'], 8086, 'root', 'root', '123', true, 4444);
var dbInflux = influx(['127.0.0.1'], 8086, 'root', 'root', '123', true, 4444);
...
app.use(function(req, res, next) {
    ...
    function logRequest() {
        ...
        dbInflux.writePoint('response_times', {
            time: startTime,
